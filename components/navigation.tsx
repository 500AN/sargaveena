...
export function Navigation() {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col items-center justify-center h-full gap-8">
          ...
          <div className="mt-8 flex flex-col gap-4">
            <a href="tel:9207271271" className="flex items-center gap-2 text-gold">
      ...
      {/* Mobile Sticky CTA */}
      <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-foreground p-4 flex gap-4">
        <a
          href="tel:9207271271"
          className="flex-1 flex items-center justify-center gap-2 py-3 bg-gold text-foreground font-medium"
        >
          <Phone className="w-4 h-4" />
          Call Now
        </a>
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 py-3 bg-background text-foreground font-medium"
        >
